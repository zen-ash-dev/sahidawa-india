...
*   Remember to add translation keys to *all* relevant locale JSON files (e.g., `en.json`, `hi.json`, `gu.json`) to ensure full multi-language support. This PR only shows `en.json`.
